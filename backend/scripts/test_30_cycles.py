...
for i in range(30):
    ...
    r = requests.post(
        BASE + "/jobs",
        headers={"Authorization": "Bearer " + contractor_tok},
        json={
            "title": "Ciclo " + str(i + 1) + " " + cat,
            "description": "test " + ts,
            "category": cat,
            "location": loc,
            "budget": budget,
    ...
    r = requests.post(
        ...
        headers={"Authorization": "Bearer " + contractor_tok, "Content-Type": "application/json"},
        json={},
        timeout=10,
    )
