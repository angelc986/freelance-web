...
print(
    "2. Apply: HTTP " + str(r4.status_code) + " " + (r4.text[:200] if r4.status_code != 200 else "")
)
...
print(
    ...
    + str(r6.status_code)
    + " "
    + (r6.text[:200] if r6.status_code != 200 else "")
)
...
print(
    ...
    + str(r8.status_code)
    + " "
    + (r8.text[:200] if r8.status_code != 200 else "")
)
...
print(
    ...
    + str(r9.status_code)
    + " "
    + (r9.text[:200] if r9.status_code != 200 else "")
)
...
r10 = requests.post(
    BASE + "/payments/release/" + str(jid), headers={"Authorization": "Bearer " + ctok}, timeout=10
)
print(
    "8. Release: HTTP "
    + str(r10.status_code)
    + " "
    + (r10.text[:200] if r10.status_code != 200 else "")
)
