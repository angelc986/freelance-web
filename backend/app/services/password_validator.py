...
_COMMON_PASSWORDS: set[str] = {
    ...
    "password1", "qwerty12345", "1234567890", "123456789a", "qwerty1",
    "1q2w3e4r", "master", "letmein", "login", "baseball",
    "dragon", "trustno1", "starwars", "whatever", "nicole",
    "access", "flower", "hello", "hottie", "lovely",
    "michael", "ninja", "mustang", "passw0rd", "shadow",
    "mynoob", "654321a", "!qaz2wsx", "superman", "1qaz2wsx",
    "pokemon", "batman", "hunter2", "trustno", "merlin",
    "ashley", "andrew", "joshua", "matthew", "jessica",
    "password123", "admin123", "letmein123", "qwerty1234", "pass1234",
    "daniel", "austin", "anthony", "taylor", "thomas",
    "george", "robert", "william", "joseph", "david",
    "richard", "charles", "christopher", "james", "oliver",
    "jack", "harry", "jacob", "charlie2", "thomas1",
    "soccer", "liverpool", "arsenal", "chelsea", "manchester",
    "blink182", "eminem", "metallica", "slipknot", "nirvana",
    "fuckyou", "fuckoff", "bitch", "asshole", "bastard",
    "freedom", "america", "canada", "england", "germany",
    "1234567890qwerty", "123456789qwerty", "12345678qwerty", "pass123", "pass1234",
}
