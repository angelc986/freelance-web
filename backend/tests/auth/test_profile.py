...
def _register(client, **kw):
    payload = {"email": "tmp@t.com", "password": PW, "full_name": "X",
               "phone": "+584149999999", "cedula": "V-99999999", "role": "worker"}
    payload.update(kw)
...
class TestRegister:
    ...
    def test_register_weak_password(self, client):
        resp = _register(client, email="wpw@t.com", cedula="V-44444444",
                         password="123")
