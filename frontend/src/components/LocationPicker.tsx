    ...
    <div className="space-y-2">
      ...
      <div className="flex gap-2">
        <div className="relative flex-1">
          <input
            ...
            className="w-full px-3 py-2 text-[12px] bg-[#F1F5F9] border border-[#E2E8F0] rounded-lg text-[#1E293B] font-medium outline-none transition-all duration-200 placeholder:text-[#94A3B8]"
          />
        ...
        <button
          ...
          className="px-3 py-2 bg-[#F1F5F9] border border-[#E2E8F0] rounded-lg text-[#475569] hover:bg-blue-50 hover:border-blue-200 hover:text-primary transition-all flex items-center gap-1.5 shrink-0 disabled:opacity-50"
        >
          {gettingLocation ? (
          ...
          <span className="text-[11px] font-medium hidden sm:inline">{gettingLocation ? "Ubicando..." : "GPS"}</span>
        </button>
      </div>
      ...
      {!pickerOpen ? (
        <button
          ...
          className="w-full py-2 text-[11px] font-medium text-primary bg-blue-50 hover:bg-blue-100 rounded-lg border border-blue-100 transition-all flex items-center justify-center gap-1.5"
        >
        ...
        <div className="rounded-xl overflow-hidden border border-gray-200 shadow-sm">
          ...
          <div className="flex items-center justify-between px-3 py-1.5 bg-gray-50 border-t border-gray-100">
            <span className="text-[10px] text-gray-400">Arrastra el pin para ajustar</span>
            <button
              type="button"
              onClick={() => setPickerOpen(false)}
              className="text-[10px] font-medium text-gray-500 hover:text-primary transition-colors"
            >
              Cerrar mapa
            </button>
          </div>
      ...
      {/* Coords display */}
      {lat != null && lng != null && !pickerOpen && (
        <div className="flex items-center gap-1.5 text-[10px] text-gray-400">
          <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z"/></svg>
