...
// --- Stagger animation trigger ---
 ...
 {/* ------- 5. COMPLETE PROFILE ------- */}
 <div className={screenClass("complete") + " screen-scroll complete-screen"} style={{paddingBottom:"120px"} }>
 ...
 <span className="text-[13px] sm:text-[12px] font-semibold text-gray-800">Datos personales</span>
 </div>
 <div className="grid grid-cols-2 gap-2">
 <div>
 <label className="block text-[11px] sm:text-[10px] font-medium text-gray-500 mb-0.5">Nombre</label>
 <input type="text" className="input-profile" placeholder="Tu nombre" value={compFirstName} onChange={e => setCompFirstName(e.target.value)} />
 </div>
 <div>
 <label className="block text-[11px] sm:text-[10px] font-medium text-gray-500 mb-0.5">Apellido</label>
 <input type="text" className="input-profile" placeholder="Tu apellido" value={compLastName} onChange={e => setCompLastName(e.target.value)} />
 </div>
 </div>
 </div>
 ...
 <span className="text-[13px] sm:text-[12px] font-semibold text-gray-800">Contacto</span>
 </div>
 <div className="grid grid-cols-2 gap-2">
 <div>
 <label className="block text-[11px] sm:text-[10px] font-medium text-gray-500 mb-0.5">Teléfono</label>
 <input type="tel" className="input-profile" placeholder="+58 414..." value={compPhone} onChange={e => setCompPhone(e.target.value)} />
 </div>
 <div>
 <label className="block text-[11px] sm:text-[10px] font-medium text-gray-500 mb-0.5">Cédula</label>
 <input type="text" className="input-profile" placeholder="V-12345678" value={compCedula} onChange={e => setCompCedula(e.target.value)} />
 </div>
 </div>
 <div className="mt-2">
 ...
 <span className="text-[13px] sm:text-[12px] font-semibold text-gray-800">Profesión</span>
 <span className="text-[9px] text-gray-400 font-medium ml-auto">Opcional</span>
 </div>
 <input type="text" className="input-profile" placeholder="Ej: Electricista, Diseñador, Programador..." value={compProfession} onChange={e => setCompProfession(e.target.value)} />
 </div>
...
{/* ------- 1. WELCOME ------- */}
 ...
 <input type={regShowPw ? "text" : "password"} className="input-field" placeholder="Contraseña" value={regPassword} onChange={e => setRegPassword(e.target.value)} autoComplete="new-password" />
 ...
 <div className="stagger"><div className="input-group">
 <svg className="input-icon" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75"/></svg>
 <input type="email" className="input-field" placeholder="Correo electrónico" value={loginEmail} onChange={e => setLoginEmail(e.target.value)} autoComplete="email" />
 </div></div>

 <div className="stagger"><div className="input-group mb-1">
 <svg className="input-icon" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z"/></svg>
 <input type={loginShowPw ? "text" : "password"} className="input-field" placeholder="Contraseña" value={loginPassword} onChange={e => setLoginPassword(e.target.value)} autoComplete="new-password" />
