      ...
      <div className="glass-container">
        ...
        <div className="absolute left-4 z-30 md:hidden" style={{top:"calc(env(safe-area-inset-top,0px) + 14px)"}}>
          <Link href="/dashboard">
            <svg width="32" height="32" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <defs><linearGradient id="lvm" x1="0" y1="0" x2="48" y2="48"><stop offset="0%" stopColor="#2563EB"/><stop offset="100%" stopColor="#1D4ED8"/></linearGradient></defs>
              <circle cx="24" cy="24" r="22" fill="url(#lvm)"/>
        ...
        <div className="top-row top-bar">
          <div className="flex items-center gap-2">
            {/* Logo + texto: solo desktop */}
            <div className="hidden md:flex items-center gap-2">
              <Link href="/dashboard">
                <svg className="w-8 h-8" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <defs><linearGradient id="tlg3" x1="0" y1="0" x2="48" y2="48"><stop offset="0%" stopColor="#2563EB"/><stop offset="100%" stopColor="#1D4ED8"/></linearGradient></defs>
                  <circle cx="24" cy="24" r="22" fill="url(#tlg3)"/>
                  <path d="M15 16h18M24 16v16" stroke="white" strokeWidth="3.5" strokeLinecap="round"/>
                  <path d="M33 28c3-2.5 4-6 3.5-9" stroke="white" strokeWidth="2" strokeLinecap="round" opacity="0.8"/>
                  <circle cx="36.5" cy="19" r="1.5" fill="white" opacity="0.8"/>
                  <circle cx="24" cy="24" r="3" fill="white" opacity="0.6"/>
            ...
            {/* Solo la flecha: visible en todos los tamaños */}
            <Link href="/dashboard" className="flex items-center justify-center" style={{width:32,height:32,borderRadius:8,color:"#475569",border:"none",background:"none",cursor:"pointer"}}>
        ...
        <div className="flex-1 flex flex-col justify-center items-center text-center px-6" style={{paddingBottom:"calc(env(safe-area-inset-bottom,0px) + 12px)"}}>
            ...
            <div className={`relative w-full h-full rounded-full flex items-center justify-center transition-all duration-700 shadow-lg ${
              ...
              {status === "verified" ? (
                <svg className="w-10 h-10 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round">
                  <path d="M20 6L9 17l-5-5" style={{strokeDasharray:30,strokeDashoffset:0,transition:"stroke-dashoffset 0.6s ease-out 0.3s"}} />
                </svg>
              ) : status === "rejected" ? (
          ...
          {status === "verified" ? (
            ...
            <>
              ...
              <p className="text-gray-500 text-[15px] max-w-[280px] mx-auto leading-relaxed mb-3">No pudimos verificar tu identidad con los datos proporcionados. Por favor, intenta de nuevo o contacta a soporte.</p>
          ...
          <Link
            ...
            className={`group relative inline-flex items-center justify-center w-full max-w-[260px] px-6 py-3.5 rounded-2xl font-semibold text-[15px] transition-all duration-300 overflow-hidden ${
              status === "verified"
                ...
                : status === "rejected"
                ? "text-red-600 border-2 border-red-200 hover:bg-red-50 hover:border-red-400"
