...
export default function VerificationCompletePage() {
  ...
  return (
    <div className="phone-frame">
      {/* Background layers (CSS-only, no JS canvas needed) */}
      ...
      <div className="glass-container">
        <div className="screen screen-active" style={{ pointerEvents: "auto" }}>
          {/* ─── Top bar: igual a auth ─── */}
          <div className="top-row top-bar">
            <div className="flex items-center gap-2">
              {/* Logo + texto: desktop only */}
              ...
              <Link href="/dashboard" className="btn-back" style={{ marginLeft: 0 }} aria-label="Volver al dashboard">
          ...
          <div className="flex-1 flex flex-col justify-center items-center text-center px-6" style={{ paddingBottom: "calc(env(safe-area-inset-bottom,0px) + 12px)" }}>
            ...
            <div className="relative mx-auto w-20 h-20 mb-5">
              ...
              <div className={`relative w-full h-full rounded-full flex items-center justify-center transition-all duration-700 shadow-lg ${
                status === "verified" ? "bg-gradient-to-br from-[#2563EB] to-[#1D4ED8] shadow-blue-200/50" :
                status === "rejected" ? "bg-gradient-to-br from-red-400 to-red-600 shadow-red-200/50" :
            ...
            {/* Button */}
            <Link
              href={status === "rejected" ? "/dashboard" : "/dashboard"}
