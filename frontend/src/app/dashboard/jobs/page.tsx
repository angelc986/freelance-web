          ...
          {filtered.length === 0 ? (
            <div className="text-center py-20 bg-white rounded-2xl border border-gray-200">
              ...
              <p className="text-dark font-medium">
                {filter === "active" ? "No tienes trabajos activos" :
              ...
              {isWorker && (
                <Link href="/jobs" className="inline-block mt-4 text-sm font-medium text-primary hover:underline">
                  Buscar trabajos disponibles
                </Link>
              )}
              {!isWorker && (
                <Link href="/jobs/new" className="inline-block mt-4 text-sm font-medium text-primary hover:underline">
                  Publicar trabajo
                </Link>
              )}
            </div>
